...
CUDA_VISIBLE_DEVICES=0 python3 -m torch.distributed.launch --nproc_per_node=1 --master_port 47780 ./main.py \
--model $model --drop_path 0.1 --batch_size 256 --lr 4e-3 \
--update_freq 16 --input_size 224 --nb_classes 1000 \
--data_path $root/datasets/$dataset/2012 \
--output $root/ConvNeXt/outputs/output_${model}_${dataset}_${time} \
--seed 0 \
--use_dcls 'yes' --dcls_gain 1 \
